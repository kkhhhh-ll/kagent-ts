...
一个 TypeScript AI Agent 框架，提供 ReAct / Plan-Solve / Fusion / Orchestrator 多种 Agent 循环范式，内置工具管理（Circuit Breaker）、会话持久化、渐进式 Skill 系统、MCP 协议支持、Reflection 反思与 Eval 评估。
